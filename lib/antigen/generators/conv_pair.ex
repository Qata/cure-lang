defmodule Antigen.Generators.ConvPair do
  ...
  defp shape do
    Gen.frequency([
      ...
      {2, ret(v(0), {:lam, {:type, 0}, {:app, v(1), v(0)}}, true, "η neutral-vs-λ (70,108)", :eta_neutral_lam)},
      {2, ret({:lam, {:type, 0}, v(1)}, {:lam, {:type, 0}, v(1)}, true, "λ-vs-λ η (107)", :eta_lam_lam)},
      {2, ret({:lam, {:type, 0}, v(1)}, {:type, 0}, false, "λ-vs-non-λ (109)", :lam_vs_nonlam)},
