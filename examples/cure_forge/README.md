...
The source files define `app Cure.CureForge`, `sup Cure.Forge.Root`, and four
...
```text
cure_src/forge_app.cure       app Cure.CureForge
cure_src/forge_root.cure      sup Cure.Forge.Root
