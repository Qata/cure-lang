defmodule CureColony.Application do
  ...
  supervisor `:"Cure.Colony"` as a child. The Cure supervisor
  ...
  `test: ["compile_cure", "test"]`, so the `:"Cure.Colony"`,
  `:"Cure.Worker"`, and `:"Cure.Echo"` modules are already
  loaded into the VM by the time this callback runs.
  """

  use Application

  @cure_sup :"Cure.Colony"
