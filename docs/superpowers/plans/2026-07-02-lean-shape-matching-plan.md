...
- [ ] **Independent adversarial verification** of 8019e67: subagent dispatched (Lean re-check first; ≥8 attack probes incl. replace_term-under-binders frame audit, capture/shadow/duplicate-name guards, erased quantities). Pending — seal on SOUND.
