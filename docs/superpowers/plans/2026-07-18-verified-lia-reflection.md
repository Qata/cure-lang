...
`test/oracle/otp/linear_arithmetic_compute.{cure,idr}`.
...
`test/oracle/otp/linear_arithmetic_semantics.{cure,idr}`.
...
**Files:** extend `lib/std/proof_linear_arithmetic.cure`; add paired
`test/oracle/otp/linear_arithmetic_certificate.{cure,idr}`.
...
`test/oracle/otp/linear_arithmetic.{cure,idr}`.
