...
The project's `mix.exs` uses `mod: {CureColony.Application, []}`-style bootstrap in tests, and `cure release` can produce the standalone release under `_build/cure/rel/cure_forge/`. Read the [Applications reference](/applications) for the tour, or [`docs/APP.md`](https://github.com/am-kantox/cure-lang/blob/main/docs/APP.md) for the on-disk reference.
...
Then jump into `examples/cure_forge/` or read the new [Applications page](/applications) for the tour, [`docs/APP.md`](https://github.com/am-kantox/cure-lang/blob/main/docs/APP.md) for the on-disk reference, and the [CHANGELOG](https://github.com/am-kantox/cure-lang/blob/main/CHANGELOG.md#0260----applications-and-releases) for the full changeset.

## What's next

The long-term radar from v0.24.0 / v0.25.0 is unchanged: profile-guided optimisation, broader IDE reach, and REPL-level hot reload. Each remains on the roadmap without a fixed slot. The repository is at [github.com/am-kantox/cure-lang](https://github.com/am-kantox/cure-lang).
