%{
  title: "Cure v0.14.0 :: Real-World Readiness",
  author: "Aleksei Matiushkin",
  tags: ~w(release package-management type-holes testing interop),
  description: "Package management, deep dependent type tracking, LSP type holes, incremental compilation, cross-module protocol dispatch, testing infrastructure, and Elixir interop."
}
---
...
The repository is at [github.com/am-kantox/cure-lang](https://github.com/am-kantox/cure-lang).
