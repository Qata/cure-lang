...
Then jump into `examples/cure_colony/` or read the new [Actors page](/actors) for the tour, [`docs/SUPERVISION.md`](https://github.com/am-kantox/cure-lang/blob/main/docs/SUPERVISION.md) for the on-disk reference, and the [CHANGELOG](https://github.com/am-kantox/cure-lang/blob/main/CHANGELOG.md#0250----typed-supervision-trees) for the full changeset.
...
The repository is at [github.com/am-kantox/cure-lang](https://github.com/am-kantox/cure-lang). v0.24.0 gave Cure the loop you actually use; v0.25.0 gives it the processes you actually supervise.
